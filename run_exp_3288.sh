...
-f=2 --opt_at=14 -n=13 -c=16 -s=4 --samloss=0 --ds_name=cifar10 --batch_size=128 --nr_gpu=2 --resnet_version=resnext --exp_gamma=0.3 --sum_rand_ratio=2 --last_reward_rate=0.8 
