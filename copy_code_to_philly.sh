...
sudo mount -t cifs //storage.gcr.philly.selfhost.corp.microsoft.com/msrlabs_scratch/dedey /mnt/msrlabs_scratch_dedey/ -o username=dedey,domain=REDMOND,iocharset=utf8
...
# Mount the msrlabs_scratch/dedey folder to /mnt/msrlabs_scratch_dedey
sudo mount -t cifs //storage.rr1.philly.selfhost.corp.microsoft.com/msrlabs_scratch/dedey /mnt/msrlabs_scratch_dedey/ -o username=dedey,domain=REDMOND,iocharset=utf8
