...
--densenet_version=atv1 -n=32 -g=32 -s=16 --ds_name=svhn --batch_size=32 --nr_gpu=2 --reduction_ratio=1 -f=2 --opt_at=-1 --samloss=0 --log_dense_base=2.0 --transition_batch_size=1 --growth_rate_multiplier=1 --bottleneck_width=4.0 --b_type=bottleneck 
