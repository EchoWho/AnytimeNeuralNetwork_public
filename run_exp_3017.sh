...
--densenet_version=dense -n=12 -g=24 -s=1 --ds_name=svhn --batch_size=64 --nr_gpu=4 --reduction_ratio=1 --loglog_growth_multiplier=3 --dense_select_method=8 -f=2 --opt_at=-1 --samloss=0 --log_dense_base=2.0 --transition_batch_size=1 --growth_rate_multiplier=1 --bottleneck_width=4.0 --b_type=bottleneck 
