...
-f=2 --opt_at=56 -n=25 -c=16 -s=9 --samloss=0 --ds_name=cifar10 --batch_size=128 --nr_gpu=4 --resnet_version=resnext --exp_gamma=0.3 --sum_rand_ratio=2 --last_reward_rate=0.8 
