...
azcopy --source /home/dedey/DATADRIVE1/ann_data_dir --destination https://phillyeustorage.blob.core.windows.net/msrlabs/dedey/ann_data_dir/ --recursive --dest-sas $mySAS --parallel-level 16
