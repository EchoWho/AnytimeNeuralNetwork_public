...
-f=2 --opt_at=8 -n=9 -c=64 -s=3 --samloss=0 --ds_name=cifar100 --batch_size=128 --nr_gpu=4 --resnet_version=resnext --exp_gamma=0.3 --sum_rand_ratio=2 --last_reward_rate=0.8 
