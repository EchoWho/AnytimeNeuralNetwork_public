...
# et1
/home/dedey/Dropbox/philly-fs/linux/philly-fs -cp -r https://phillyeustorage.blob.core.windows.net/msrlabs/dedey/AnytimeNeuralNetwork_master gfs://et1/msrlabs/dedey/AnytimeNeuralNetwork_master
