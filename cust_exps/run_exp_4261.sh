...
-f=5 --samloss=100  --block_config=8,8,8,9 -s=8 --batch_size=256 --nr_gpu=4 --min_predict_unit=8 --adaloss_gamma=0.01 --adaloss_final_extra=3 --adaloss_update_per=1000 --opt_at=-1 --num_classes=1000 
