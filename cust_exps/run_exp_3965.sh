...
--adaloss_gamma=0.07 --adaloss_update_per=1 --adaloss_momentum=0.9 --adaloss_final_extra=1.0 --sum_rand_ratio=0 --is_select_arr -f=5 --samloss=100  -d=101 -s=3 --batch_size=64 --nr_gpu=2 --resnet_version=resnet --opt_at=-1 -c=64 --num_classes=1000 
