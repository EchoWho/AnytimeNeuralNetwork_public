...
--adaloss_gamma=0.07 --adaloss_update_per=1 --adaloss_momentum=0.9 --adaloss_final_extra=0.5 --sum_rand_ratio=0 --is_select_arr -f=5 --samloss=100  -d=26 -s=2 --batch_size=128 --nr_gpu=4 --resnet_version=resnext --opt_at=-1 -c=64 --num_classes=1000 
