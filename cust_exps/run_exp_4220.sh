...
-f=5 --samloss=100  --block_config=6,8,8,8 -s=5 --batch_size=256 --nr_gpu=4 --min_predict_unit=8 --adaloss_gamma=0.01 --adaloss_final_extra=0 --adaloss_update_per=600 --opt_at=-1 --num_classes=1000 
