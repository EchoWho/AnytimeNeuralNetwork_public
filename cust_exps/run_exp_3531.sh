...
-f=10 --samloss=6  --densenet_depth=169 -s=14 --batch_size=128 --nr_gpu=4 --densenet_version=dense --min_predict_unit=10 --reduction_ratio=0.5 --opt_at=-1 -g=32 --num_classes=1000 
