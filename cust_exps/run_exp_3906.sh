...
-f=10 --samloss=6  --densenet_depth=201 -s=17 --batch_size=256 --nr_gpu=8 --densenet_version=dense --min_predict_unit=10 --reduction_ratio=0.5 --dropout_kp=0.9 --opt_at=-1 -g=32 --num_classes=1000 
