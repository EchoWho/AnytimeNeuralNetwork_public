...
-f=2 --samloss=0  --block_config=6,6,12,12 -s=7 --batch_size=256 --nr_gpu=4 --densenet_version=dense --min_predict_unit=10 --reduction_ratio=0.5 --b_type=bottleneck --s_type=imagenet --prediction_feature=rescale --opt_at=-1 -g=32 --num_classes=1000 
