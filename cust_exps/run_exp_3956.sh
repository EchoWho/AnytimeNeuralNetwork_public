...
--adaloss_gamma=0.07 --adaloss_update_per=1 --adaloss_momentum=0.9 --adaloss_final_extra=0.5 --sum_rand_ratio=0 --is_select_arr -f=5 --samloss=100  --msdensenet_depth=38 --batch_size=128 --nr_gpu=4 --opt_at=-1 -g=16 --num_classes=1000 --num_scales=4 --prediction_feature=msdense --min_predict_unit=4 
