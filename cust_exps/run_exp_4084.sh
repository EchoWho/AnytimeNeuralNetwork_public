...
--adaloss_gamma=0.07 --adaloss_update_per=1 --adaloss_momentum=0.9 --adaloss_final_extra=1.0 --sum_rand_ratio=0 --is_select_arr -f=5 --samloss=100  --block_config=5,5,10,10 -s=6 --batch_size=256 --nr_gpu=4 --min_predict_unit=4 --opt_at=-1 --num_classes=1000 
