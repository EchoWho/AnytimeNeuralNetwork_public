...
-f=2 --densenet_depth=265 -s=24 --batch_size=128 --nr_gpu=4 --densenet_version=dense --min_predict_unit=10 --opt_at=-1 --samloss=6 -g=32 --num_classes=1000 --reduction_ratio=0.5 
