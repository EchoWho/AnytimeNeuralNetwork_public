...
-f=5 --samloss=100  --block_config=10,9,10,9 -s=7 --batch_size=64 --nr_gpu=1 --min_predict_unit=4 --adaloss_gamma=0.05 --adaloss_final_extra=0 --adaloss_update_per=600 --opt_at=-1 --num_classes=1000 
