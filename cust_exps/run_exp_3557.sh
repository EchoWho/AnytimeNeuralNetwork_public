...
-f=2 --samloss=0  --densenet_depth=369 -s=35 --batch_size=64 --nr_gpu=4 --densenet_version=atv1 --min_predict_unit=10 --reduction_ratio=1 --opt_at=-1 -g=32 --num_classes=1000 --b_type=bottleneck 
