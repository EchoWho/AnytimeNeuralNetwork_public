...
-f=2 --samloss=0  --densenet_depth=35 -s=3 --batch_size=256 --nr_gpu=8 --densenet_version=dense --min_predict_unit=10 --reduction_ratio=0.5 --dropout_kp=0.9 --prediction_feature=rescale --opt_at=-1 -g=32 --num_classes=1000 
