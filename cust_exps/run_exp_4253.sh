...
-f=5 --samloss=100  --block_config=6,6,10,10 -s=7 --batch_size=256 --nr_gpu=4 --min_predict_unit=8 --adaloss_gamma=0.1 --adaloss_final_extra=1.5 --adaloss_update_per=1000 --opt_at=-1 --num_classes=1000 
