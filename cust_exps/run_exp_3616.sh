...
-n=9 -c=32 -s=1 --ds_name=cifar100 --batch_size=64 --nr_gpu=1 --samloss=100 --adaloss_gamma=0.0 --adaloss_momentum=0.99 --adaloss_final_extra=1.0 --adaloss_update_per=100 --sum_rand_ratio=0 --is_select_arr -f=5 
