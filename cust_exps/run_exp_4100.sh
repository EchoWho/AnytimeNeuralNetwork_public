...
-f=5 --samloss=100  --block_config=5,5,10,10 -s=6 --batch_size=256 --nr_gpu=4 --min_predict_unit=4 --adaloss_gamma=0.05 --adaloss_final_extra=0 --opt_at=-1 --num_classes=1000 
