...
-f=5 --samloss=100 --exp_gamma=0.07 --sum_rand_ratio=0 --is_select_arr  --msdensenet_depth=23 --batch_size=256 --nr_gpu=8 --opt_at=-1 -g=16 --num_classes=1000 --num_scales=4 --prediction_feature=msdense --min_predict_unit=4 
