...
--densenet_version=dense -n=22 -g=24 -s=11 --ds_name=cifar10 --batch_size=32 --nr_gpu=2 -f=2 --samloss=0 --opt_at=-1 --log_dense_base=2.0 --transition_batch_size=1 --growth_rate_multiplier=1 --bottleneck_width=4.0 --reduction_ratio=0.5 --b_type=bottleneck 
